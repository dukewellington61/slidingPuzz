...
var SlidingPuzzle = function SlidingPuzzle(props) {
  var level = 4;
  var nought = "*";
  var styleSpan = {
    width: '50px',
  ...
  var createStartArray = function createStartArray() {
    var puzzleArray = new Array(level);
    var counter = 0;
  ...
  var _useState = (0, _react.useState)(createStartArray()),
      _useState2 = _slicedToArray(_useState, 2),
      puzzleElements = _useState2[0],
      setPuzzleElements = _useState2[1];
  ...
  var _useState5 = (0, _react.useState)(false),
      ...
      gameWon = _useState6[0],
      setGameWon = _useState6[1];

  var updateUseStates = function updateUseStates(arr) {
    setPuzzleElements(_toConsumableArray(arr));
  ...
  var checkIfGameWon = function checkIfGameWon(array) {
    var endArray = array.flat([level - 1]);
    var startArray = createStartArray().flat([level - 1]);
    var winCondition = [];
  ...
  var shuffleArray = function shuffleArray() {
    for (var i = 0; i < puzzleElements.length; i++) {
      for (var j = 0; j < puzzleElements[i].length; j++) {
        var i1 = Math.floor(Math.random() * puzzleElements.length);
        var j1 = Math.floor(Math.random() * puzzleElements.length);
        var temp = puzzleElements[i][j];
  ...
  var findPositionTile = function findPositionTile(arr, tile) {
    var y, x;
  ...
  var isSolveAble = function isSolveAble(array) {
    var arrayFlat = array.flat([level - 1]).filter(function (x) {
      return x != nought;
    });
    var inv_count = 0;
    ...
    var _findPositionTile = findPositionTile(array, nought),
        _findPositionTile2 = _slicedToArray(_findPositionTile, 2),
        noughtTileY = _findPositionTile2[0],
        noughtTileX = _findPositionTile2[1];

    if (level == 2) {
      if (noughtTileY % 2 != 0 && inv_count % 2 == 0 && checkIfGameWon(puzzleElements) != true) return true;else return false;
    }

    ;

    if (level % 2 != 0) {
      if (inv_count % 2 == 0 && checkIfGameWon(puzzleElements) != true) return true;else return false;
    }
  ...
  var swapPositionTiles = function swapPositionTiles(event) {
    var _findPositionTile3 = findPositionTile(puzzleElements, nought),
        _findPositionTile4 = _slicedToArray(_findPositionTile3, 2),
        noughtTileY = _findPositionTile4[0],
        noughtTileX = _findPositionTile4[1];

    var _findPositionTile5 = findPositionTile(puzzleElements, event.target.innerHTML),
        _findPositionTile6 = _slicedToArray(_findPositionTile5, 2),
        numberTileY = _findPositionTile6[0],
        numberTileX = _findPositionTile6[1];
  ...
  return _react.default.createElement("div", null, _react.default.createElement("div", null, gameWon == true && "Bravo! Es ist geschafft."), puzzleElements.map(function (el, indexRow) {
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./SlidingPuzzle":"SlidingPuzzle.js"}],"../../../../.npm/_npx/3166/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../.npm/_npx/3166/lib/node_modules/parcel/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/Einsendeaufgabe.e31bb0bc.js.map